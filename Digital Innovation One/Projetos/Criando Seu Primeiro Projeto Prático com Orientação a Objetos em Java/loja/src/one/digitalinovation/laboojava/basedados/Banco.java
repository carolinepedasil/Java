...
/*
	Classe responsável por simular um banco de dados. Esta faz as inserções e exclusões da aplicação. 
	Atualizações não são permitidas para facilitar o funcionamento da aplicação.
*/
public class Banco {
